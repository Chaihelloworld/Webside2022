          ...
          <Col sm="12" md={{ size: 8, offset: 2 }}>
            ...
            <div className={stylesAOS['x_feature']} id="x_feature" >
              <div
                ...
                data-aos-once="true"
              >
                <h3 style={{ color: '#3c3838',fontSize:'30px' ,fontWeight:600}}>Chiangrai-Decarbonization City (CDC): เพื่อการพัฒนาเมืองคาร์บอนต่ำที่น่าอยู่สร้างเศรษฐกิจสีเขียวและแหล่งท่องเที่ยวระดับนานาชาติ 
               </h3>
               <br/>
               <div style={{marginLeft:30}}>
               <h6 style={{ color: '#3c3838',fontSize:'25px'  }}>วัตถุประสงค์</h6>
                <h6 style={{ color: '#797979',fontSize:'20px' }}>• เพื่อพัฒนาเทคโนโลยีพร้อมใช้ Green Technology ที่สอดคล้องกับบริบทของธุรกิจต้นแบบเป้าหมายในพื้นที่เทศบาลนครเชียงราย</h6>
                <h6 style={{ color: '#797979' ,fontSize:'20px'}}>• เพื่อประเมินมาตรฐาน การควบคุมและการประเมินโครงการลงทุนเพื่อลดการปล่อยก๊าซเรือนกระจกจากการใช้พลังงานไฟฟ้าในส่วนธุรกิจต้นแบบเป้าหมายในพื้นที่เทศบาลนครเชียงราย</h6>
                </div>
